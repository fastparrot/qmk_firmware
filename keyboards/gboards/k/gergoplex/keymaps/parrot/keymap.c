...
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_RSFT,    KC_Z),  KC_X, KC_C, KC_V,     KC_B,  KC_N, KC_M, KC_COMM, KC_DOT,  MT(MOD_RSFT, KC_SLSH),
 		...
 		MT(MOD_LCTL, KC_TAB), MT(MOD_LALT, KC_DEL), LT(SYMB, KC_BSPC),									// Left
...
[SYMB] = LAYOUT_gergoplex(
    ...
    KC_LSFT, KC_GRV,  KC_LPRN, KC_UNDS, KC_TILD,   KC_MINS,  KC_PPLS, KC_RPRN,  KC_EQL,  KC_RSFT,
...
[NUMB] = LAYOUT_gergoplex(
    ...
    KC_BTN2,  KC_MS_L,  KC_MS_D,  KC_MS_R,  KC_BTN3,  		KC_ACL2, KC_PGUP, KC_PGDN, KC_TAB,  KC_VOLD
     						KC_F11, KC_F12, KC_BTN1,  	    KC_TRNS, KC_MPLY, KC_MNXT
    )
};
